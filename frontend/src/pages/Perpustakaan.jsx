      ...
      <main className="main-content" style={{ marginLeft: 0 }}>
        ...
        <div className="content-area">
          ...
          <div style={{ marginTop: '-1rem', marginBottom: '-0.5rem', fontSize: '0.9rem', color: '#64748b', display: 'flex', alignItems: 'center', gap: '0.4rem', fontWeight: 500, paddingLeft: '0.2rem' }}>
            ...
            <span>/</span>
            <span style={{ color: '#0f172a' }}>Perpustakaan BKN</span>
          </div>

          {/* ── HERO BANNER ── */}
          <div className="hero-banner">
            <div className="hero-banner-content">
              <h1>Perpustakaan BKN</h1>
              <p>Halaman ini sedang dalam tahap pengembangan. Segera hadir untuk layanan<br />referensi dan literatur kepegawaian.</p>
